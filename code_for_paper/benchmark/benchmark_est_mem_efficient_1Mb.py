...
def mem_efficient_sampling(proportion=0.1):
    x = sparse.load_npz('/tmp/oe_sparse_1Mb.npz')
    start = time.time()
    index_s = 0
    std = []
    c = []
...
if __name__ == '__main__':
    ...
    pc1_path = "/media/jordan990301/Samsung_T5/HiC_Datasets/data_for_hicpep/data_store/data/lieberman_2009/eigenvectors/GM-combined.ctg2.ctg2.1000000bp.hm.eigenvector.tab"
